...
function setupEventListeners(ui) {
    ...
    if (ui.birthdayInput && ui.birthdayInput.addEventListener) {
    ...
    if (ui.citySearch && ui.citySearch.addEventListener) {
    ...
    if (ui.methodSelect && ui.methodSelect.addEventListener) {
